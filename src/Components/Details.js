...
class Details extends React.Component {
    ...
    componentDidMount() {
        ...
        axios({
            method: 'GET',
            url: `https://zomato-bn.herokuapp.com/restaurant/${restaurant}`,
    ...
    GetMenuItems = () => {
        ...
        axios({
            method: 'GET',
            url: `https://zomato-bn.herokuapp.com/menuitems/${restaurantId}`,
            headers: { 'Content-Type': 'application/json' }
        })
            .then(response => {
    ...
    getData = (data) => {
        return fetch(`https://zomato-bn.herokuapp.com/payment`, {
            method: "POST",
            headers: {
